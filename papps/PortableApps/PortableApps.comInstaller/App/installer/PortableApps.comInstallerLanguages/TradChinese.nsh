...
LangString platformnewinstalldetails ${LANG_TRADCHINESE} "安裝 PortableApps.com 平台的新版本到本機電腦、雲端磁碟機或可攜裝置"
LangString platformupgradeinstall ${LANG_TRADCHINESE} "升級現有安裝版本"
LangString platformupgradeinstalldetails ${LANG_TRADCHINESE} "升級 PortableApps.com 平台的現有版本"
...
LangString platforminstallerlang ${LANG_TRADCHINESE} "TradChinese"