...
user in an INI file next to RufusPortable.exe called RufusPortable.ini.
...
copy AppNamePortable.ini from this directory to RufusPortable.ini next to
RufusPortable.exe. The options in the INI file are as follows:
