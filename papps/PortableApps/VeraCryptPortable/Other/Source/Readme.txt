...
user in an INI file next to VeraCryptPortable.exe called VeraCryptPortable.ini.
...
copy AppNamePortable.ini from this directory to VeraCryptPortable.ini next to
VeraCryptPortable.exe. The options in the INI file are as follows:
